export const ValidateConst: IValidate[] = [
  ...
  },
  {
    ...
    regex: /^(?=(?:.*[A-Z]){2,})(?=(?:.*[a-z]){1,})(?=(?:.*\d){2,})(?=(?:.*[!@#$%\/()=?\[\]¿}+\-:;,.-_*°¬^~]){0,})([A-Za-z0-9]{7,20})$/
  },
  {
    type: 'email',
  ...
  {
    type: 'majorZeroIgual',
    message: 'El monto debe ser mayor o igual 0.',
    regex: /^(0*[0-9][0-9]*(\.[0-9]+)?|0+\.[0-9]*[0-9][0-9]*)$/
  },
  {
  ...
  },
  {
    ...
    message: 'El campo no debe contener 4 o mas caracteres repetidos y/o 2 caracteres especiales repetidos',
    regex: /^(?!.*?([-,. ])\1)(?!.*?([\w])\2{3,}).+$/
  },
  {
    type: 'alphanumericBasicSymbolsLogin',
    message: 'El campo no debe contener caracteres especiales',
    regex: /^[a-zA-Z0-9-,.;+*{#$%&!|●}]*$/
  },
  {
    type: 'userAlias',
    message: 'El Alias debe tener letras mayúsculas(2), minúsculas, números(2) y sin caracteres especiales',
    regex: /^(?=(?:.*[A-Z]){2,})(?=(?:.*[a-z]){1,})(?=(?:.*\d){2,})(?=(?:.*[!@#$%\/()=?\[\]¿}+\-:;,.-_*°¬^~]){0,})([A-Za-z0-9]{7,20})$/
  },
  {
    type: 'newAlisUser',
    message: 'El Alias debe tener letras minúsculas y números(2)',
    regex: /^(?=(?:.*[a-z]){1,})(?=(?:.*\d){2,})(?=(?:.*[!@#$%\/()=?\[\]¿}+\-:;,.-_*°¬^~]){0,})([A-Za-z0-9!@#$%\/()=?\[\]¿}+\-:;,.-_*°¬^~]{7,20})$/
  }
];
