...
export class BallotOfWarrantyDto extends ProcessBatchDto {
  ...
  warrant: string = '';
  WarrantPrenda: string = '';
  WarrantAlmacen: string = '';
  WarrantGiro: string = '';
  
  FirstNamef: string = '';
  FirstCiFianzaf: string = '';
  FirstDomiciliof: string = '';
  SecondNamef: string = '';
  SecondCiFianzaf: string = '';
  SecondDomiciliof: string = '';
  ThirdNamef: string = '';
  ThirdCiFianzaf: string = '';
  ThirdDomiciliof: string = '';
  FourthNamef: string = '';
  FourthCiFianzaf: string = '';
  FourthDomiciliof: string = '';
  Otros: string = '';
  TerceraConformidad: string = '';
