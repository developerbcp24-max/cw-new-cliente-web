...
declare let $: any;
@Component({
  selector: 'app-cash-in-line-spreadsheet',
  standalone: false,
  templateUrl: './cash-in-line-spreadsheet.component.html',
  styleUrls: ['./cash-in-line-spreadsheet.component.css'],
  providers: [ParametersService, UtilsService]
})
export class CashInLineSpreadsheetComponent implements OnInit, OnChanges, AfterViewChecked {
  ...
  detail: CashPaymentsInLineSpreadsheetsResult = new CashPaymentsInLineSpreadsheetsResult();
  @Input() spreadsheetPerPage!: CashPaymentsInLineSpreadsheetsResult[];
  @Input() visible: boolean | string | any = false ;
  @Input() disabled: boolean = false;
  @Input() batchInformation!: CashPaymentInLineData;
  ...
  setNewRow(): void {
    this.detail = new CashPaymentsInLineSpreadsheetsResult();
  ...
  handleShowEditForm($event: CashPaymentsInLineSpreadsheetsResult): void {
