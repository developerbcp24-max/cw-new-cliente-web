...
import { PublicWritingDetailResult } from '../../../../Services/new-ballot-of-warranty/models/public-writing-detail-result';
...
@Component({
  selector: 'app-new-others-of-ballot',
  standalone: false,
  templateUrl: './new-others-of-ballot.component.html',
  styleUrls: ['./new-others-of-ballot.component.css'],
  providers: [ParametersService,
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => NewOthersOfBallotComponent),
      multi: true
    }]
})
export class NewOthersOfBallotComponent implements OnInit {
  ...
  constructor(private parameterService: ParametersService,
    ...
    private newBallotOfWarrantyService: NewBallotOfWarrantyService) {
  }
  ...
  getPublicWriting() {
    this.newBallotOfWarrantyService.getPublicWritingDetail().subscribe({next: (resp: PublicWritingDetailResult[]) => {
