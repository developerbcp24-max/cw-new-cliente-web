...
@Component({
  selector: 'app-depecrated-pagination',
  standalone: false,
  templateUrl: './depecrated-pagination.component.html',
  styleUrls: ['./depecrated-pagination.component.css']
})
export class DepecratedPaginationComponent implements OnInit, OnChanges {
